<?php
require_once '../shared/includes/db_connect.php'; // Adjusted path
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name) || empty($email) || empty($phone)) {
        ...
        $stmt = $pdo->prepare("SELECT id FROM leaders WHERE email = ?");
        $stmt->execute([$email]);
        if ($stmt->fetch()) {
            ...
            $stmt->execute([$name, $email, $phone, $year, $course, $completion_year, $ministry, $position, $docket]);
...
<body>
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <h2 class="text-center mb-4"><i class="fas fa-user-plus"></i> Register as Leader</h2>
                <?php if ($errors): ?>
                ...
                <form method="POST" class="card p-4 slide-in">
                    ...
                    <div class="mb-3">
                        <label for="year" class="form-label"><i class="fas fa-calendar"></i> Year of Study</label>
                    ...
                    <div class="mb-3">
                        <label for="ministry" class="form-label"><i class="fas fa-church"></i> Ministry</label>
                    ...
                    <div class="mb-3">
                        <label for="docket" class="form-label"><i class="fas fa-briefcase"></i> Docket</label>
