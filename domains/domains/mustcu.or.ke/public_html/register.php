            ...
            <div class="col-md-8">
                ...
                <form method="POST" class="card p-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label"><i class="fas fa-calendar"></i> Year of Study</label>
                    ...
                    <div class="mb-3">
                        <label class="form-label"><i class="fas fa-graduation-cap"></i> Expected Completion Date</label>
