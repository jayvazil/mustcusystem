...
define('BASE_URL', 'https://mustcu.or.ke');


// Define DB constants with explicit string type
define('DB_HOST', 'localhost');
define('DB_USER', 'uvwehfds_mustcu');   // Replace with your DB user
define('DB_PASS', '7ZwV6yxXKGrD2LPn5eSH');   // Replace with your DB password
